...
\bmng
\bnum
\num{1} savxra rUpAMtara; savxravayxtayxya; savxradalilx uMTAguva vayxtAyxsa (\udA\ jamaRnf \eng{Mann, M}\eng{$\ddot\bg\rm a\eg$}\eng{nner;} iMgilxSf \eng{man, men).} 
\num{2} (\kanmu\ jamARYxnikf BASegaLalilx) idanunx sUcisalu savxrAkaSxrada meVle hAkuva eraDu cukekx\eng{$\ddot\bg\phantom\bg a\eg\eg$} gaLa cihenx; savxravisaMdhi cihenx, \udA\ \eng{M}\eng{$\ddot\bg\rm a\eg$}\eng{nner.} 
\enum
\emng
\eentry
...
\alnum{b} (horajiyanunx) saDilabiDu. 
...
\pron{aMDarfgoV}
\gl{\sakirx}
\expl{(\parxpu\ \Eva\ vataRmAnakAla \eng{undergoes}; \BU\ \eng{underwent}; \BUkaq\ \eng{undergone}).}
\bmng
...
\num{4} (hesaru, sananxDate, \mo vanunx) keDisu; hALu mADu; nAshakikxVDu mADu (\kanmu\ \BUkaq dalilx Iga \viparx): \eng{`alas}! \eng{I am undone' she sobbed out} `ayoyxV! nAnu keTeTx' eMdu avaLu bikikxbikikx atatxLu. 
\enum
\emng
\eentry
...
\bmng
\bnum
\num{1} (\kAparx) keYtege: \eng{`unhand me, villain}!' \eng{she cried} nananxnunx biTuTxbiDu, naninxMda keYtege, niVca! eMdu avaLu kiricidaLu. 
...
\bentry
\word{unstatutable} 
\pron{anfsATxYxTuyx(cu)Taba(bf)lf} 
\gl{\gu}
\expl{}
\bmng
...
\pron{anfTArxYx(TArx)nfsxleVTabiliTi} 
\gl{\nA}
\expl{}
\bmng
\bnum
...
\bentry
\word{untranslatable} 
\pron{anfTArxYx(TArx)nfsxleVTabflf} 
\gl{\gu}
\expl{}
\bmng
\bnum
...
\bentry
\word{untranslatably} 
\pron{anfTArxYx(TArx)nfsxleVTabilx} 
\gl{\kirxvi}
\expl{}
\bmng
\bnum
