...
\alnum{b} (\ca) siDubige vinAyiti uMTumADalu vAyxkisxVnf Agi baLasutitxdadx, danasiDubu veYrasf. 
\eanum
\emng
\eentry
...
\num{3} budidhxshUnayx yA BAvashUnayx: \eng{a vacuous remark} budidhxshUnayxvAda yA athaRhiVnavAda -- mAtu, TiVke. \eng{a vacuous stare} shUnayxdaqSiTx. 
\enum
\emng
\eentry
...
\expl{}
\bmng
 shUnayxdaqSiTxyiMda; budidhx yA BAva shUnayxvAda noVTadiMda: \eng{he stared at me vacuously} avanu nananx kaDe shUnayxdaqSiTxyiMda noVDutitxdadx. 
\emng
\eentry
...
\bmng
\bnum
\num{1} (gotutxguri ilalxde) aledADuva; sutAtxDutatxleV iruva; alemAriyAda: \eng{a vagrant tribe} oMdu alemAri buDakaTuTx. 
...
\num{3} (vasutxvina, viSayada) bele; yoVgayxte; pArxmuKayx; mahatatxvX; guNa: \eng{I now learnt the value of fresh water} sihiniVrina bele EneMbudu nanage Iga tiLiyitu. \eng{I now learnt the value of a friend} senxVhitana mahatatxvX nanage Iga tiLiyitu. 
...
\expl{}
\bmng
 (\ravi) vaneVDiyamf; paramANu saMKeyx \eng{23} matutx paramANu tUka \eng{51}uLaLx, visheVSa riVtiya ukukxgaLa tayArikeyalilx baLasalAguva, bUdubaNaNxda gaTiTxyAda loVhadhAtu. 
\emng
\eentry
...
\bmng
\bnum
\num{1} \eng{(Vandal)} vAYxMDalf; \eng{4 -- 5}neV shatamAnagaLalilx gAlf, sepxVnf, \kanu\ Aphirxka, matutx roVmf deVshagaLanunx koLeLxmADi, garxMtharAshiyanUnx kalAkaqtigaLanUnx nAsha mADida, jamARyxnikf buDakaTiTxna vAyxMDalf eMba taMDadavanu. 
...
\expl{}
\bmng
 (\rUpa, savxrUpa, kAguNita, jAti, pATha, \mo vugaLa) Binanxte; rUpAMtara; aMtara; BeVda: \eng{`enure' is a variant of `inure'. `enure'} eMbudu \eng{`inure'} eMbudara BinanxrUpa, rUpAMtara. 
\emng
\eentry
...
\expl{}
\bmng
 (\eng{very} eMbudara tamarUpa). (\pArxparx) 
\bnum
\num{1} nijavAda. 
...
\bnum
\num{1} sari, tALe, tAkaRNe -- noVDu: \eng{always verify your references} ninanx ulelxVKagaLanunx tapapxde sarinoVDu, sariyAgideye eMbudanunx Kacita mADiko. 
\num{2} parishiVlane, parxyoVga yA pariVkeSxgaLa mUlaka viSayavu satayx yA sari eMbudanunx rujuvAtupaDisu: \eng{I must verify his statement} avana heVLike nijave eMbudanunx nAnu pariVkiSxsi noVDabeVku. 
...
\alnum{b} oMdu dajeRya sarakina utApxdaneya elAlx haMtagaLanUnx oLagoLuLxva: \eng{vertical integration} AdayxMta saMGaTane; buDadiMda tudiyavaregina elAlx BAgagaLanUnx saMGaTisuvudu, samagarxgoLisuvudu. 
\eanum
\numie
...
\numi{1} 
\banum
\alnum{a} keTaTx -- guNa, savxBAva; aniVti; dubuRdidhx; avaguNa; durAcAra; duguRNa; dushishxVla: \eng{drunkenness is not among his vices} avana durAcAragaLalilx kuDitavu oMdalalx. 
...
\num{5} koVpiSaThx; duSaTx; kutisxta; kubudidhxya: \eng{vicious dog} duSaTxnAyi. \eng{vicious mood} koVpiSaThx manoVvaqtitx. \eng{vicious remarks} kutisxta TiVkegaLu. 
...
\num{2}\eng{kinematic viscosity} gativeYjAcnxnika sinxgadhxte; oMdu mAna sAMdarxtege eSuTx balAtamxka sinxgadhxte eMbudara aLate yA parimANa. 
\enum
\emng
\eentry
...
\expl{}
\bmng
 \eng{vulcanology} eMbudara rUpAMtara. 
\emng
\eentry
...
\alnum{b} dhavxniya tuMbu; shAriVrada yA vAdayxda nAdada tuMbu. 
\eanum
\numie
